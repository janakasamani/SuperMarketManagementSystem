...
class AddItemRequest(Model):
    ...
    def __init__(self, name: str=None, type: str=None, price: float=None, expiry_date: date=None):  # noqa: E501
        ...
        :type name: str
        :param type: The type of this AddItemRequest.  # noqa: E501
        :type type: str
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'AddItemRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The AddItemRequest of this AddItemRequest.  # noqa: E501
        :rtype: AddItemRequest
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self) -> str:
        """Gets the name of this AddItemRequest.


        :return: The name of this AddItemRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str):
        """Sets the name of this AddItemRequest.


        :param name: The name of this AddItemRequest.
        :type name: str
        """
        if name is None:
    ...
    @property
    def type(self) -> str:
        """Gets the type of this AddItemRequest.


        :return: The type of this AddItemRequest.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str):
        """Sets the type of this AddItemRequest.


        :param type: The type of this AddItemRequest.
        :type type: str
        """
        if type is None:
    ...
    def price(self) -> float:
        """Gets the price of this AddItemRequest.


        :return: The price of this AddItemRequest.
        :rtype: float
        """
        return self._price
    ...
    def price(self, price: float):
        """Sets the price of this AddItemRequest.


        :param price: The price of this AddItemRequest.
        :type price: float
        """
        if price is None:
